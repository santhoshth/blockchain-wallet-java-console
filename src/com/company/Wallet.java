...
public class Wallet {
    ...
    public Transaction sendFunds(PublicKey _recipient,float value ) throws NoSuchAlgorithmException, SignatureException, NoSuchProviderException, InvalidKeyException {
